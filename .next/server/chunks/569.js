exports.id=569,exports.ids=[569],exports.modules={1135:()=>{},1472:(a,b,c)=>{"use strict";c.r(b),c.d(b,{default:()=>j,metadata:()=>h,viewport:()=>i});var d=c(5338),e=c(8039),f=c.n(e);c(1135);var g=c(4677);let h={title:"Kullanımlık Fotoğraf Y\xfckleme",description:"Fotoğraflarınızı g\xfcvenli bir şekilde paylaşın - sadece bir kez g\xf6r\xfcnt\xfclenebilir"},i={width:"device-width",initialScale:1,userScalable:!1};function j({children:a}){return(0,d.jsxs)("html",{lang:"tr",suppressHydrationWarning:!0,children:[(0,d.jsxs)("head",{children:[(0,d.jsx)("meta",{name:"format-detection",content:"telephone=no"}),(0,d.jsx)("meta",{name:"format-detection",content:"date=no"}),(0,d.jsx)("meta",{name:"format-detection",content:"address=no"}),(0,d.jsx)("meta",{name:"format-detection",content:"email=no"}),(0,d.jsx)("meta",{name:"apple-mobile-web-app-capable",content:"yes"}),(0,d.jsx)("meta",{name:"apple-mobile-web-app-status-bar-style",content:"black-translucent"}),(0,d.jsx)("meta",{name:"apple-touch-fullscreen",content:"yes"}),(0,d.jsx)("meta",{name:"mobile-web-app-capable",content:"yes"}),(0,d.jsx)("meta",{name:"theme-color",content:"#000000"}),(0,d.jsx)("meta",{name:"referrer",content:"no-referrer"}),(0,d.jsx)("meta",{httpEquiv:"Content-Security-Policy",content:"default-src 'self' 'unsafe-inline' 'unsafe-eval' data: https:; img-src 'self' data: https:; media-src 'self' data:;"}),(0,d.jsx)("style",{dangerouslySetInnerHTML:{__html:`
        ...
        `,document.head.appendChild(a)})();let e=document.createElement("style");return e.textContent=`
        * {
          -webkit-touch-callout: none !important;
          -webkit-user-select: none !important;
          -webkit-tap-highlight-color: transparent !important;
        ...
        body::after {
          content: "\xa9 G\xfcvenli İ\xe7erik - Kopyalanamaz";
          position: fixed;
          top: 0;
          left: 0;
          width: 100%;
      ...
      `,document.head.appendChild(e),()=>{document.removeEventListener("touchstart",a),document.removeEventListener("touchmove",a),document.removeEventListener("touchend",a),document.removeEventListener("contextmenu",b),document.removeEventListener("selectstart",c),document.removeEventListener("copy",d),document.removeEventListener("cut",d),document.removeEventListener("paste",d),e.parentNode&&e.parentNode.removeChild(e)}}},[])}},5594:(a,b,c)=>{Promise.resolve().then(c.t.bind(c,1170,23)),Promise.resolve().then(c.t.bind(c,3597,23)),Promise.resolve().then(c.t.bind(c,6893,23)),Promise.resolve().then(c.t.bind(c,9748,23)),Promise.resolve().then(c.t.bind(c,6060,23)),Promise.resolve().then(c.t.bind(c,7184,23)),Promise.resolve().then(c.t.bind(c,9576,23)),Promise.resolve().then(c.t.bind(c,3041,23)),Promise.resolve().then(c.t.bind(c,1384,23))},8580:(a,b,c)=>{Promise.resolve().then(c.bind(c,2966))}};